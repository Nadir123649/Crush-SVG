                                                ...
                                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="mobile-logo-center" style="display: inline-block; vertical-align: middle;">
                                                    <tr>
                                                        <td valign="middle" style="padding-right: 6px;">
                                                            <a href="https://www.crushsvg.net/" target="_blank"><img src="https://res.cloudinary.com/df80crgrw/image/upload/v1786610399/CrushSVG-logo_qsusgx.png" width="42" height="42" alt="CrushSVG" border="0" class="logo-mobile" style="display: block;"></a>
                                                        </td>
                                                        <td valign="middle" class="logo-text-mobile" style="font-family: 'Bricolage Grotesque', sans-serif; font-size: 34px; font-weight: 700; color: #353A3E; line-height: 1;">
                                                            <a href="https://www.crushsvg.net/" target="_blank" style="color: #353A3E; text-decoration: none;">Crush<span style="color: #D94A1E;">SVG</span></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                            ...
                            <tr>
                                <td align="center" style="padding-top: 30px;">
                                    <a href="https://www.crushsvg.net/" target="_blank"
                            ...
                            <tr>
                                <td align="center"
                                    style="padding-top: 10px; font-family: 'Afacad', sans-serif; font-size: 12px; font-weight: 400; line-height: 100%; color: #D1C7BD;">
                                    <a href="https://www.crushsvg.net/privacy-policy" target="_blank"
                                        style="color: #D1C7BD; text-decoration: none;">Privacy Policy</a> &bull;
                                    <a href="https://www.crushsvg.net/terms" target="_blank"
                                        style="color: #D1C7BD; text-decoration: none;">Terms</a> &bull;
                                    <a href="https://www.crushsvg.net/support" target="_blank"
