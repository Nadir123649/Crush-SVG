...
import { getAuth, GoogleAuthProvider, sendEmailVerification, signInWithPopup, signOut as firebaseSignOut, type Auth, type AuthError, } from "firebase/auth";
...
export function getErrorMessage(error: unknown): string {
    ...
    switch (code || message) {
        ...
        case "auth/invalid-api-key":
            return "Firebase is misconfigured \u2014 check the NEXT_PUBLIC_FIREBASE_* environment variables";
        case "auth/configuration-not-found":
            return "Firebase auth domain is misconfigured \u2014 check NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN";
        case "auth/unauthorized-continue-uri":
            return "This redirect is not allowed by Firebase \u2014 check your allowed redirect URIs";
