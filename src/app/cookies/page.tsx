    ...
    <div className="w-full flex justify-center py-[40px] md:py-[80px]">
      <article className="w-full max-w-[800px] flex flex-col gap-[24px]">
        ...
        <section className="flex flex-col gap-[16px]">
          <h2 className="font-heading font-semibold text-[24px] text-[#353A3E]">1. What Are Cookies?</h2>
        ...
        <section className="flex flex-col gap-[16px]">
          <h2 className="font-heading font-semibold text-[24px] text-[#353A3E]">2. How We Use Cookies</h2>
          <p className="font-body font-normal text-[16px] text-[#5A524C] leading-[160%]">
        ...
        <section className="flex flex-col gap-[16px]">
          <h2 className="font-heading font-semibold text-[24px] text-[#353A3E]">3. Types of Cookies We Use</h2>
          <p className="font-body font-normal text-[16px] text-[#5A524C] leading-[160%]">
        ...
        <section className="flex flex-col gap-[16px]">
          <h2 className="font-heading font-semibold text-[24px] text-[#353A3E]">4. Third-Party Cookies</h2>
          <p className="font-body font-normal text-[16px] text-[#5A524C] leading-[160%]">
        ...
        <section className="flex flex-col gap-[16px]">
          <h2 className="font-heading font-semibold text-[24px] text-[#353A3E]">5. Your Choices Regarding Cookies</h2>
          <p className="font-body font-normal text-[16px] text-[#5A524C] leading-[160%]">
        ...
        <section className="flex flex-col gap-[16px]">
          <h2 className="font-heading font-semibold text-[24px] text-[#353A3E]">6. Updates to This Policy</h2>
          <p className="font-body font-normal text-[16px] text-[#5A524C] leading-[160%]">
        ...
        <section className="flex flex-col gap-[16px]">
          <h2 className="font-heading font-semibold text-[24px] text-[#353A3E]">7. Contact Us</h2>
          <p className="font-body font-normal text-[16px] text-[#5A524C] leading-[160%]">
