...
export async function generateMetadata({ params }: UseCasePageProps) {
  ...
  if (!useCase) {
    return constructMetadata({ title: 'Not Found', description: 'This use case does not exist.' });
  }
  return constructMetadata({
    title: `${useCase.title} | CrushSVG`,
    description: useCase.description,
    canonicalPath: `/use-case/${useCase.slug}`,
    ...
    <div className="w-full flex flex-col items-center md:pb-[60px] min-h-[60vh]">
      ...
      <div className="w-full max-w-[800px] flex flex-col gap-[32px] md:gap-[48px]">
        ...
        >
          ...
          {/* Quick tool callout inside the card — same as svg-guides */}
      ...
      {/* The Core Converter UI — full width, outside the card column */}
      <ConverterUI />
