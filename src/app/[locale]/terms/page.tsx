  ...
  return (
    <div className="w-full flex justify-center pb-[40px] md:pb-[80px]">
      <article className="w-full max-w-[800px] flex flex-col gap-[24px]">
        ...
        <Hero
          badge={t("badge")}
          title={<>{t("title").split(" ")[0]} <span className="bg-gradient-to-r from-brand-primary to-brand-secondary text-transparent bg-clip-text">{t("title").split(" ").slice(1).join(" ") || "Service"}</span></>}
