...
export function ResetPasswordCard() {
  return (
    <div className="w-[440px] h-[374px] bg-[#FFFCFA] rounded-[8px] p-[24px_32px] shadow-[0px_4px_44px_0px_rgba(0,0,0,0.06)] flex flex-col mx-auto border-[1px] border-[#F2EDE8] relative">
      ...
      <div className="flex flex-col w-[376px] gap-[12px] mx-auto relative h-full">
