      ...
      <div className="flex flex-col w-[376px] gap-[12px] mx-auto relative mt-[4px]">
        ...
        <div className="text-center mt-[4px]">
          <p className="font-afacad font-normal text-[11px] leading-[12px] text-[#AEAEAE]">
            By creating an account, you agree to our <Link href="/terms" className="font-semibold hover:text-[#D94A1E]">Terms of Service</Link> & <Link href="/privacy" className="font-semibold hover:text-[#D94A1E]">Privacy Policy.</Link>
          </p>
        </div>
      </div>
    </div>
